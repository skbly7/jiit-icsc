...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>2015 JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; TPC Members</title>
    ...
    <div class="b_page clearfix">
        <div id="content">
            ...
            <div class="post-295 page type-page status-publish hentry post">
                            ...
                            <div class="b w_940">
                                <h2 class="entry-title">TPC Members</h2>
                            </div>
                            ...
                            <div class="b w_620">
                                ...
                                <!-- post meta -->
<?php
$names=array("Prof.  Jaromir Pistora","Prof. K. Sunduchkov","Prof. Jianping Yao","Prof. S. Prasad","Prof. Devi Chadha",
				"Prof. V. K. Jain","Prof. Arun Kumar","Prof. V.K Jain",
					"Prof. R. Bahl","Arun Kumar","Prof. A. K. Saxena",
				"Prof. Mridula Gupta","Prof. Jaromir Pistora","Prof. K. Sunduchkov");
$college=array("VSB-Technical University of Ostrava","National Technical University of Ukraine","University of Ottawa","Northeastern University","Indian Institute of Technology Delhi",
				"Indian Institute of Technology Delhi","Indian Institute of Technology Delhi","Indian Institute of Technology Delhi",
				"Indian Institute of Technology Delhi","Indian Institute of Technology Delhi","Indian Institute of Technology Roorkee",
