...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Around Delhi</title>
...
<!--End ganalytic-->
        ...
        <!-- javascript -->
		<script type="text/javascript" src="fancybox/hmm.js"></script>
...
-->
    ...
    <body  class="page page-id-395 page-template-default logged-in larger" style="background-color:#4bb6e6 ; background-image: url(lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-395 page type-page status-publish hentry post">
                            ...
                            <div class="b w_940">
                                <h2 class="entry-title">Around Delhi</h2>
                            </div>
                            ...
                            <div class="b w_620">
                                ...
                                <ul class="xoxo">
                                    <li class="widget">
                                        <div class="b_text">
                                            <div id="wrap">
<p>		<img src="images/map.jpg" alt="" usemap="#logos" style="margin-left:-20px;" /></p>
<map name="logos">
<area  id= "various3" shape="rect" coords="26,72,138,202" href="#" title="IGI Airport" alt="IGI" />
<area  id= "various2" shape="rect" coords="466,66,664,254" href="around-delhi/lotus-temple.php" title="Lotus Temple" alt="Lotus Temple" />
<area id= "various1" shape="rect" coords="60,488,232,708" href="around-delhi/india-gate.php" title="India Gate" alt="India Gate" />
<area id= "various5" shape="rect" coords="738,160,932,422" href="around-delhi/kingdom-of-dreams.php" title="Kingdom of Dreams" alt="KOD" />
<area id= "various4" shape="rect" coords="770,478,932,742" href="outside-delhi/agra-uttar-pradesh.php" title="Taj Mahal" alt="Taj Mahal" />
<area id= "various6" shape="rect" coords="514,380,652,650" href="around-delhi/qutab-minar.php" title="Qutab Minar" alt="Qutab Minar" />
</map></div>
                                                                                    </div>
                                    </li>
                                </ul>
