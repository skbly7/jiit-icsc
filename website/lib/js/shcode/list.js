...
function ResetSample(){
	jQuery('#ordered_list').change(function() {
		...
		jQuery("#ordered_sample option:first").attr('selected','selected');
	...
	jQuery('#unordered_list').change(function() {
		...
		jQuery("#unordered_sample option:first").attr('selected','selected');
...
function setDefault(){
	...
	jQuery('#list_type option:first').attr('selected','selected');
	jQuery('#unordered_sample').hide();
	jQuery('#ordered_sample').show();
	...
	jQuery("#ordered_list option:first").attr('selected','selected');
	jQuery("#unordered_list option:first").attr('selected','selected');
