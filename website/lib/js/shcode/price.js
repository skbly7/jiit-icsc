(function($){
    var defaultOptions = {
        ...
        "class"         : 'pricing_box jq-generic-price-col',   /* default class of column */
    ...
    $.fn.price = function( options ){
        ...
        return this.each(function(){
            ...
            container.append( '<input type="button" value="Add Price Table" class="generic-record-button  button-primary" />' );
    ...
    $.fn.body = function( opt ){
        ...
        for( var i = 0; i < opt.number; i++ ){
            ...
            this.append('<div class="'+ opt.class + '" id="' + opt.id + '-' + i + '"></div>');
