...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof. Mridula Gupta</title>
...
-->
    ...
    <body  class="single single-session-chair postid-354 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-354 session-chair type-session-chair status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Prof. Mridula Gupta</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img class="size-full wp-image-233 alignleft" alt="" src="../2013/04/2793.jpg"></p>
<p style="text-align: justify;">Prof. Mridula Gupta is an Professor in Department of Electronic Science, University of Delhi South Campus, New Delhi. She completed her B.Sc. (H) (Physics) from University of Delhi in 1984, M.Sc. (Electronics) University of Delhi 1986, M.Tech University of Delhi 1988 and Ph.D from University of Delhi in 1998. Her teaching and research interest include Modeling &amp; characterization of submicron and deep submicron field effect devices. This includes the Si MOSFET, MESFET, GaAs MESFET and GaAs/InP HEMT. She has published around 57 papers in various national and international journals/conferences. She Received University Gold Medal in 1986 for being the best candidate in the M.Sc. (Electronics) examination also awarded Nehru Centenary Common Wealth Fellowship (UK) for three years in 1990.</p>
                                                                            </div>
                                </li>
                            </ul>
