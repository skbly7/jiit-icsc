...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof. B. K. Mohanty</title>
...
-->
    ...
    <body  class="single single-session-chair postid-437 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-437 session-chair type-session-chair status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Prof. B. K. Mohanty</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img class="alignleft" alt="RKS" src="../2013/05/BKMohanty.jpg" /></p>
<p style="text-align: justify;">
Received B.Sc and M.Sc degree (both with first-class honors) in Physics from Sambalpur University, Orissa, in 1987 and 1989, respectively. Received Ph.D degree in the area of VLSI for Digital Signal Processing from Berhampur University, Orissa in 2000.<br />
In 1992 he was selected by OPSC (Orissa Public Service Commission) and joined as faculty member in the Department of Physics, SKCG College (Autonomous) Paralakhemundi, Orissa. In 2001 he joined as Lecturer in EEE Department, BITS Pilani, Rajasthan. Then he joined as an Assistant Professor in the Department of ECE, Mody Institute of Education Research (Deemed University), Rajasthan. In 2003 he joined Jaypee University of Engineering and Technology, Guna, Madhya Pradesh, where he becomes Associate Professor in 2005 and full Professor in 2007.<br />
Currently he serves as the reviewers of IEEE Transactions on Circuits and Systems-II: Express Briefs, IEEE Transactions on Circuits and Systems for Video Technology, IEEE Transactions on Very Large Scale Integration (VLSI) Systems. IET Circuit Device and Technology and Journal of Circuit, System and Signal Processing, Springer. He has member of various technical committees of International Conferences Sponsored by IEEE. Track Chair of “Multimedia Signal Processing Track”, International Symposium on Consumer Electronics (ISCE2011), Singapore and “Digital System Design and Validation Track” track of International Symposium of Electronics System Design (ISED2011), Kochi, India.</p>
<p>A Senior Member of IEEE and Life Time Member of IETE (Institution of Electronics and Telecommunication Engineering), New Delhi, India.<br />
His research interest includes algorithm design, mapping and implementation for high-performance, resource-constrained multi-media signal processing applications and secured communication. He has published nearly 30 technical papers. List of papers published after joining JUET is given in the publication list.</p>
                                                                            </div>
                                </li>
                            </ul>
