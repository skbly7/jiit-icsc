...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof. Bani Singh</title>
...
-->
    ...
    <body  class="single single-session-chair postid-445 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-445 session-chair type-session-chair status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Prof. Bani Singh</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img class="alignleft" alt="RKS" src="../2013/05/BANI.jpg" /></p>
<p style="text-align: justify;">Life member of Indian Society of Industrial and Applied Mathematics (ISIAM)<br />
Completed one AICTE Project on Computer Animation. Guided six Ph.Ds and more than 35 M.Tech, M.Phil dissertations.<br />
Reviewed a large number of papers in national and international journals of Sound and Vibrations, Academic Press UK.<br />
Examined a large number of Ph.D. Theses and Dissertations in the University of Roorkee and Several other Institutions including the IITs.<br />
National fellowship holder right up to M. Sc.<br />
Best student award and a gold medal for the session 1963–1964.<br />
Several awards of books and medals for standing first in the class.<br />
Took active part in debates and other extra curricular activities.<br />
Favorite game is badminton.<br />
Worked as O.C. Maintenance, O.C. Mechanics Lab, O.C. Computation Lab etc.<br />
Member of Several Committees at the Department as well as University level.<br />
Modified and introduced a large number of courses.<br />
Completed one AICTE project on Physical modeling of vibration problems.<br />
Worked in various capacities, in workshops, seminars and conferences held by the department including  editor and organizing secretary.<br />
Khosla Award for outstanding research work awarded jointly.</p>
                                                                            </div>
                                </li>
                            </ul>
