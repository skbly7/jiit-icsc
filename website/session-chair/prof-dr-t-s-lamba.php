...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof.  T. S. Lamba</title>
...
-->
    ...
    <body  class="single single-session-chair postid-432 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-432 session-chair type-session-chair status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Prof.  T. S. Lamba</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p> <img class="size-full wp-image-233 alignleft" alt="" src="../2013/05/juit_faculty_profileada551c5c5.jpg" /></p>
<p style="text-align: justify;">Prof. T. S. Lamba obtained his B.Sc(Hons) degree in Physics from St. Xavier&#8217;s College under the University of Calcutta and then B.Tech(Hons) degree in Electronics and Electrical Communication Engineering from I.I.T Kharagpur. At Kharagpur, he also obtained his Ph.D. working on the low bit rate digitization of speech waveforms. Before joining the Jaypee University of Information Technology as Dean (Academic and Research), he has been on the staff of Department of Electronics and Electrical Communication Engineering at the IIT Kharagpur from 1972 till June 2006 when he retired. At IIT Kharagpur he has been Chairman of the Telecommunication Centre and also Chairman of the G.S.Sanyal School of Telecommunications He has specialized in Digital Communication and has been carrying out research in areas like speech processing and communication security. He has won several technical awards including the National Research and Development Corporation&#8217;s invention award and the VASVIK award. He was instrumental in organizing the National Conference on Communication in 1999 and 2005He has been actively involved in organizing and conducting student activities in several schools and colleges. These activities include quizzes, science projects and seminars. He has been involved in IEEE Section and the IEEE student branch activities and is currently the Branch Counselor at the JUIT Waknaghat. He has received the outstanding Branch Counselor award of the IEEE.</p>
                                                                            </div>
                                </li>
                            </ul>
