...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof. Sunil Bhooshan</title>
...
-->
    ...
    <body  class="single single-session-chair postid-434 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-434 session-chair type-session-chair status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Prof. Sunil Bhooshan</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img class="alignleft" alt="RKS" src="../2013/05/juit_faculty_profilec79a2f520b.jpg" /></p>
<p style="text-align: justify;">Educational Info<br />
BTech: IIT Delhi<br />
MS: University of Illinois at Urbana-Champaign<br />
PhD : University of Illinois at Urbana-Champaign</p>
<p>Research Interests</p>
<p>His  research has been in the area of<br />
1. Milli-meter wave dielectric waveguides: a novel technique to investigate such guides where (imaginary) electric and magnetic currents are introduced to limit the fields to a smaller area and then analysed.</p>
<p>2. DSP filters: use of a special transformation to obtain any given linear phase filter&#8211; concentrating on the magnitude response as in antennas: special microstrip antennas</p>
<p>3. Signal compression: use of various compression techniques.</p>
                                                                            </div>
                                </li>
                            </ul>
