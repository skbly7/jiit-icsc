...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Mr. Nitendra Rajput</title>
...
-->
    ...
    <body  class="single single-session-chair postid-352 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-352 session-chair type-session-chair status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Mr. Nitendra Rajput</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img class="size-full wp-image-233 alignleft" alt="" src="../2013/04/nitendra.jpg" /></p>
<p style="text-align: justify;">Nitendra Rajput is a Senior Researcher with IBM India Research Lab (IRL). He likes to build novel interaction systems, especially for resource-constraint mobile devices targeting low-literate users. Lately he has been working on developing telephony conversational solutions aimed to increase penetration of IT to the population at the bottom of the economic pyramid. He is working on the Spoken Web- a voice-driven ecosystem parallel to that of the WWW. Spoken Web is a network of Voice Sites that can be created by end-users (such as farmers, electricians, carpenters) through their cell-phones using voice as the primary medium of interaction. Specifically, he focuses on navigation and search related problems for the Spoken Web. He is broadly interested in mobile interactions, statistical signal processing, recommender systems and multimodal search. He recently authored a book with Amit Anil Nanavati titled &#8220;Speech in Mobile and Pervasive Environments&#8221; that has been published by John Wiley &amp; Sons.</p>
                                                                            </div>
                                </li>
                            </ul>
