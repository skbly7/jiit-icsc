...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Dr. Kaushik Saha</title>
...
-->
    ...
    <body  class="single single-session-chair postid-441 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-441 session-chair type-session-chair status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Dr. Kaushik Saha</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img class="alignleft" alt="RKS" src="../2013/05/myphoto-239x300.jpg" /></p>
<p style="text-align: justify;">
Dr. Kaushik Saha joined STMicroelectronics Ltd.(previously SGS-Thomson Microelectronics Ltd) in 1996, after having obtained his B.Tech, M.Tech. and Ph.D. degrees from Indian Institute of Technology, Delhi. He joined the organization as a designer of semiconductor memories in the Memory Products Group. Subsequently, he worked for the Applications Lab of the company and was involved in the design of consumer electronics systems around the devices designed and fabricated by the company. He is currently Principal Member Technical Staff in the Advanced Systems Technologies group of STMicroelectronics, which is the group involved in research and development of future generations of devices and systems planned by the company for the markets of tomorrow. His research interests are in the areas of Advanced Processor Architectures and Parallel Algorithms &#038; Architectures for Digital Signal Processing Applications in which he has holds various patents and has extensive publications. He is also associated with the Indian Institute of Technology, Delhi in the capacity of Adjunct Faculty.</p>
                                                                            </div>
                                </li>
                            </ul>
