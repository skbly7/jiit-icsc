...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof. Raj Senani</title>
...
-->
    ...
    <body  class="single single-speaker postid-318 larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
                                    <div class="post-318 speaker type-speaker status-publish hentry post">
                            <!-- social sharing -->
							                            

                            <div class="b w_940">
                                <h2 class="entry-title">Prof. Raj Senani</h2>
                            </div>
                            ...
                            <div class="b w_620">
								...
								<p><img class="size-full wp-image-233 alignleft" alt="" src="../2013/04/Raj_Senani_2011.jpg" /></p>
<p style="text-align: justify;">Professor Raj Senani is a Director in Netaji Subhas Institute of Technology (NSIT). He  received B.Sc from Lucknow University, B.Sc Engg from Harcourt Butler Technological Institute, Kanpur, M.E. (Honors) from M.N.R. Engineering College, Allahabad and Ph.D in Electrical Engg. (Active Networks) from the University of Allahabad. Professor Senani&#8217;s teaching and research interests are in the areas of Circuits and Systems, Bipolar and CMOS analog integrated circuits, Current mode signal processing, Electronic Instrumentation, Chaotic nonlinear circuits and log domain/Translinear circuits. He has authored and co-authored 90 research papers in the above areas in IEEE (USA), IEE (UK) and other international journals of repute. He served as an Honorary Editor of the Research Journal of the Institution of Electronics and Telecommunication Engineers (IETE, India) during 1990-1995, in the area of Circuits and Systems and has been a member of the Editorial board of the IETE Journal on Education since 1995. He is listed in several editions of Marquis&#8217; Who&#8217;s Who in the World, Marquis&#8217; Who&#8217;s Who in Science and Engineering, Marquis&#8217; Who&#8217; Who in Finance and Industry (all published from N.J , USA); 2000 Outstanding Scholars of the 21st Century and Outstanding people of the 20th Century (both published by International Biographical Centre, Cambridge); Indo-American Who&#8217;s Who (2001), Indo-Asian Who&#8217;s Who (2003) and a number of other international biographical directories.</p>
                                                </div>
