...
-->
    ...
    <body  class="single single-speaker postid-39 larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
                                    <div class="post-39 speaker type-speaker status-publish hentry post">
                            <!-- social sharing -->
                                    ...
                                    <li class="widget">
                                        <div class="b_text">
                                            ...
                                            <!-- featured images and caption -->
                                                ...
                                                <!-- content -->
                                                <div class="b_txt_content" style="text-align: justify;">
...
<div class="b w_300">
<ul class="xoxo">
<li id="registration-4" class="widget"><div class="registration"><p>2013 - ICSC</p><p class="desc">December 12 - 14, 2013</p><p class="exc">Jaypee Institute of Information Technology</p><p class="button hover blue register no_float"><a href="../reg.php">register for the event<span>&nbsp;</span></a></p><div class="end">&nbsp;</div><!--ads the end background--></div></li>
</ul></div></div>
