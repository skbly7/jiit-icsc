...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Prof. Vinod Kumar</title>
...
-->
    ...
    <body  class="single single-speaker postid-38 larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
                                    <div class="post-38 speaker type-speaker status-publish hentry post">
                            <!-- social sharing -->
							                            

                            <div class="b w_940">
                                <h2 class="entry-title">Prof. Vinod Kumar</h2>
                            </div>
