...
<li>
<div class="wp-caption alignleft circle"><a href="speaker/s-c-dutta-roy.php"><img src="2015/04/Untitled.png" alt="Prof. S. C. Dutta Roy" /></a></div><h4><a class="readmore" href="speaker/s-c-dutta-roy.php">Prof. S. C. Dutta Roy<span class="mosaic-overlay">&nbsp;</span></a></h4><span  class="exc"  style="text-align: justify;">
Professor Suhash Chandra Dutta Roy earned his BSc (Hons) in Physics (1956), MSc (Tech) in Radio Physics and Electronics (1959), and DPhil degree (1965) all from the University of Calcutta. He worked as Research Officer (Electronics) at the River Research Institute,West Bengal (WB) for two years, before joining the University of Kalyani, as a lecturer. He was Assistant Professor of Electrical Engineering at the University ...</span><p class="button readmore hover margin15"><a href="speaker/s-c-dutta-roy.php">Continue reading<span>&nbsp;</span></a></p></li>
								
                </ul ></div></li></ul><div class="pag"><ul class="b_pag center p_b"><li><span class="page-numbers current">1</span></li><li><a class="page-numbers" href="speaker2.php">2</a></li><li><a class="no_link page-numbers" href="speaker2.php">Next &raquo;</a></li></ul></div>            </div>
        </div>
