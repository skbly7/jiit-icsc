...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Lotus Temple</title>
...
-->
    ...
    <body  class="single single-ncrregion postid-372 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-372 ncrregion type-ncrregion status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Lotus Temple</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img alt="" class=" wp-image-233 alignleft" src="../2013/04/lotus-temple-delhi_400_300-300x225.jpg" width="200" height="150" /> <strong style="margin-top: -20px;">Distance (from JIIT): </strong>25Km</p>
<p style="text-align: justify;">The Bahá&#8217;í House of Worship in New Delhi, India, popularly known as the Lotus Temple because of its flowerlike shape, is a Bahá&#8217;í House of Worship and also a prominent attraction in Delhi. It was completed in 1986 and serves as the Mother Temple of the Indian subcontinent. It has won numerous architectural awards and been featured in hundreds of newspaper and magazine articles.</p>
                                                                            </div>
                                </li>
                            </ul>
