...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    <head>
        ...
        <title>JIIT-ICSC &raquo; International Conference on Signal Processing and Communication &raquo; Qutab Minar</title>
...
-->
    ...
    <body  class="single single-ncrregion postid-376 logged-in larger" style="background-color:#4bb6e6 ; background-image: url(../lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<marquee behavior="alternate" style="font-family:calibri;font-size:15px;margin-top:-10px;" scrollamount="2"><b><?php $homepage = file_get_contents('../notice.php');echo $homepage; ?></b></marquee>
    ...
    <div class="b_page clearfix">
        <div id="content">
            <!--left side-->
            <div class="post-376 ncrregion type-ncrregion status-publish hentry post">
            						<!-- social sharing -->
                        
						<div class="b w_940">
                            <h2 class="entry-title">Qutab Minar</h2>
                        </div>
                        ...
                        <div class="b w_620">
                            ...
                            <!-- post content -->
                                ...
                                <li class="widget">
                                    <div class="b_text">
                                        <p><img alt=""  class=" wp-image-233 alignleft" src="../2013/04/qutab-minar_400_300-300x225.jpg" width="200" height="150" /><strong style="margin-top: -20px;">Distance (from JIIT): </strong>30Km</p>
<p style="text-align: justify;">Qutab Minar is a soaring, 73 m-high tower of victory, built in 1193 by Qutab-ud-din Aibak immediately after the defeat of Delhi&#8217;s last Hindu kingdom. The tower has five distinct storey’s, each marked by a projecting balcony and tapers from a 15 m diameter at the base to just 2.5 m at the top. The first three storeys are made of red sandstone; the fourth and fifth storey’s are of marble and sandstone.</p>
                                                                            </div>
                                </li>
                            </ul>
