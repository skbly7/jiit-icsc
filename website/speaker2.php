...
-->
    ...
    <body  class="archive paged post-type-archive post-type-archive-speaker logged-in paged-2 post-type-paged-2 larger" style="background-color:#4bb6e6 ; background-image: url(lib/images/pattern/pattern.flowers.png);" onload="initialize()">
...
<p><h3 style="font-family : calibri; font-size : 16px;">Brief Profile of Keynote Speakers with their vast research experience in various fields are listed below :</h3></p><br /><br />
            ...
            <div class="b w_620 category">
                <ul class="xoxo"><li class="widget"><div class="b_text"><ul class="sponsors images ul shortcodes">                	         
								                                <!-- featured images -->
                                <li><div class="wp-caption alignleft circle"><a href="speaker/dr-v-k-jain.php"><img src="2015/04/vkj2004-150x211.jpg" alt="Prof. V. K. Jain" /></a></div><h4><a class="readmore" href="speaker/dr-v-k-jain.php">Prof. V. K. Jain<span class="mosaic-overlay">&nbsp;</span></a></h4><span  class="exc"  style="text-align: justify;">
Prof. V. K. Jain obtained M.Sc (Tech) degree in Electronics from the Birla Institute of Science and Technology, Pilani in the year 1975 and Ph.D degree in Communication Engineering from the Electrical Engineering Department, Indian Institute of Technology, Delhi (IITD), New Delhi in the year 1982. During the period December 1978 to November 1982, he was Research Officer with the Research Department, All India Radio, Government...</span><p class="button readmore hover margin15"><a href="speaker/dr-v-k-jain.php">Continue reading<span>&nbsp;</span></a></p></li>	
                            
                </ul ></div></li></ul><div class="pag"><ul class="b_pag center p_b"><li><a class="no_link page-numbers" href="speaker.php">&laquo; Previous</a></li><li><a class="page-numbers" href="speaker.php">1</a></li><li><span class="page-numbers current">2</span></li></ul></div>            </div>
        </div>
